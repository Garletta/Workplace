...
public class shiyan1Activity extends AppCompatActivity {
    ...
    private static final String NAME = "linjinxiong";
    ...
    final Intent intent3 = new Intent("shiyan4",Uri.parse("http://shiyan4.forth"));
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {      //子菜单事件
        ...
        switch(item.getItemId()){
            ...
            case R.id.menu1:
                ...
                return true;
            case R.id.menu3:
                Toast.makeText(this, "存储设置", Toast.LENGTH_LONG).show();
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {     //快捷菜单
        ...
        menu.add(0,CONTEXT_MENU_2,0,"修改");
        menu.add(0,CONTEXT_MENU_3,0,"删除");
    }
    ...
    @Override
    protected void onStart() {   //读取数据
        super.onStart();
        editText.setText(shared.getString("name","林锦雄"));
        editText2.setText(shared.getString("height","172"));
        editText3.setText(shared.getString("weight","60"));
        radioGroup.check(shared.getInt("sex",R.id.radioButton));
        checkBox.isChecked();
        spinner.setSelection(shared.getInt("major",0));
    }

    @Override
    protected void onPause() {   //写入文件中
        super.onPause();
        SharedPreferences.Editor editor = shared.edit();
        editor.putString("name",editText.getText().toString());
        editor.putString("height",editText2.getText().toString());
        editor.putString("weight",editText3.getText().toString());
        editor.putInt("sex",radioGroup.getCheckedRadioButtonId());
        editor.putBoolean("hobby",checkBox.isChecked());
        editor.putInt("major",spinner.getSelectedItemPosition());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shared = getSharedPreferences(NAME,MODE);
        ...
        list2.add("林锦雄");
        students.add(new Student("林锦雄","172","60","男","旅游，运动","计算机"));
        list2.add("湖畔");
        students.add(new Student("湖畔","170","55","女","旅游，运动，其他","物联网"));
        list2.add("卖奶茶");
        students.add(new Student("卖奶茶","167","70","男","其他","计算机"));
        ...
        final Intent intent3 = new Intent("shiyan3.service");   //服务
